  ...
  return (
    ...
    <div className="bg-white rounded-xl shadow-md relative" key={job.id}>
      <div className="p-4">
        ...
        <div className="mb-5">{showMore ? job.description : description}
            <button onClick={() => setShowMore(!showMore)} className="text-indigo-500 hover:text-indigo-600">{showMore ? 'Less' : 'More'}</button>
        </div>
